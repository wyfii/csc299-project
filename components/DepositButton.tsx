...
export default function DepositButton({ vaultAddress, vaultIndex, asMenuItem = false }: DepositButtonProps) {
      ...
      {asMenuItem ? (
        <button
          ...
          className="
            ...
            text-gray-400 hover:text-trench-orange hover:bg-gray-900/50
